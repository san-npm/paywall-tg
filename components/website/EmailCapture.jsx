      ...
      <div className="max-w-xl mx-auto text-center">
        ...
        <form className="flex flex-col sm:flex-row gap-2" onSubmit={(e) => e.preventDefault()}>
          <input
            ...
            className="flex-1 px-4 py-3 rounded-lg bg-site-bg border border-site-border text-site-text text-sm placeholder:text-site-dim focus:outline-none focus:border-site-accent"
          />
          <button
            type="submit"
            className="px-5 py-3 rounded-lg bg-site-accent text-white font-medium text-sm hover:bg-site-accent-hover transition-colors whitespace-nowrap"
          >
            Get the playbook
          </button>
        </form>
