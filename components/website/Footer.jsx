        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-site-muted">
              <li><Link href="/how-to-sell-on-telegram" className="hover:text-site-text">How to sell on Telegram</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-site-muted">
              ...
              <li><Link href="/use-cases/sell-digital-products-on-telegram" className="hover:text-site-text">Sell digital products</Link></li>
