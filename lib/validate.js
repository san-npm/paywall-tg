...
export function validateInitDataDetailed(initData) {
  ...
  params.delete('hash');
  // Only `hash` is excluded from the bot-token data_check_string. The Ed25519
  // `signature` field (third-party validation) is part of the HMAC input and
  // MUST be kept, or valid initData from clients that send it fails to validate.
