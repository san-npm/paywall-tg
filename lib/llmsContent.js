...
// Shared long-form reference text surfaced at /llms-full.txt and also
// returned by the Markdown-for-Agents handler at /api/md/*.
export function getLlmsFullText() {
  return `# Gategram — Full Context for LLMs
...
- Content types: text, links, files (PDFs/ebooks/templates), photos, video, messages
...
- ${SITE_URL}/ — Homepage
- ${SITE_URL}/how-to-sell-on-telegram — Step-by-step guide to sell products and content on Telegram
- ${SITE_URL}/telegram-paywall — What a Telegram paywall is and how to set one up
...
- ${SITE_URL}/vs/donate-bot — Comparison with donation bots
- ${SITE_URL}/vs/stripe-payment-links — Comparison with Stripe Payment Links
- ${SITE_URL}/vs/sendpulse — Comparison with SendPulse
- ${SITE_URL}/vs/tribute — Comparison with Tribute
- ${SITE_URL}/alternatives/gumroad-for-telegram — Gumroad alternative for Telegram
- ${SITE_URL}/alternatives/lemon-squeezy-telegram — Lemon Squeezy alternative for Telegram
- ${SITE_URL}/alternatives/patreon-for-telegram — Patreon alternative for Telegram
- ${SITE_URL}/alternatives/ko-fi-telegram — Ko-fi alternative for Telegram
- ${SITE_URL}/alternatives/buymeacoffee-telegram — Buy Me a Coffee alternative for Telegram
- ${SITE_URL}/use-cases/telegram-paid-content — Selling paid content on Telegram
- ${SITE_URL}/telegram-paid-content-unlocker — Honest answer: you cannot bypass Telegram Stars paywalls (and how to sell instead)
- ${SITE_URL}/use-cases/sell-digital-products-on-telegram — Selling digital products on Telegram
- ${SITE_URL}/use-cases/sell-courses-on-telegram — Selling courses on Telegram
- ${SITE_URL}/use-cases/sell-trading-signals — Selling trading signals on Telegram
- ${SITE_URL}/use-cases/crypto-alpha-telegram — Selling crypto alpha on Telegram
