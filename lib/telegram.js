...
export function initMiniApp(tg) {
  ...
  // Sync header + background with the app's purple theme.
  try { tg.setHeaderColor('#f5eeff'); } catch {}
  try { tg.setBackgroundColor('#fdf9ff'); } catch {}
  try { tg.setBottomBarColor?.('#f5eeff'); } catch {}
}
