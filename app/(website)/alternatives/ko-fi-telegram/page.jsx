...
export default function KoFiAlternative() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Alternatives', item: 'https://gategram.app/alternatives/ko-fi-telegram' },
      { '@type': 'ListItem', position: 3, name: 'Ko-fi Alternative for Telegram', item: 'https://gategram.app/alternatives/ko-fi-telegram' },
    ],
  };
