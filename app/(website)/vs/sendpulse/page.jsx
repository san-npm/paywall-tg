...
export default function VsSendPulse() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Compare', item: 'https://gategram.app/vs/sendpulse' },
      { '@type': 'ListItem', position: 3, name: 'Gategram vs SendPulse', item: 'https://gategram.app/vs/sendpulse' },
    ],
  };
